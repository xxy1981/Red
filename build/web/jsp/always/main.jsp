...
<HTML >
	<HEAD>
		...
		<meta http-equiv="refresh" content="60;url=${ctxPath}/refresh.do?action=always">
	</HEAD>
	...
	<table width="100%">
			<tr>
				...
				<td align="right">
					<input type="button" value="刷新" style="width: 55px;height:18;" onclick="javascript:window.location='${ctxPath}/refresh.do?action=always'">
				</td>
			</tr>
			<tr>
