...
<HTML >
	<HEAD>
		...
		<meta http-equiv="refresh" content="120;url=${ctxPath}/refresh.do?action=mmgd">
	...
	<table width="100%">
			<tr>
				...
				<td align="right" width="5%">
					<input type="button" value="买↓" style="width:55px;height:18;" onclick="javascript:window.location='${ctxPath}/refresh.do?action=mmgd&sort=b'">
				</td>
				<td align="right" width="5%">
					<input type="button" value="卖↓" style="width:55px;height:18;" onclick="javascript:window.location='${ctxPath}/refresh.do?action=mmgd&sort=s'">
				</td>
				<td align="right" width="5%">
					<input type="button" value="刷新" style="width:55px;height:18;" onclick="javascript:window.location='${ctxPath}/refresh.do?action=mmgd'">
				</td>
			</tr>
			<tr>
					...
					<table width="100%" bgcolor="#765"  border="0" cellspacing="1" cellpadding="0">
						...
						<tr align="right" style="background-color:#DEFFAC;color:#137A4F;" onmouseover="this.style.backgroundColor='#FFD306'" onmouseout="this.style.backgroundColor='#DEFFAC'">
							...
							<td align="center" style="color:#2F0000;">
								<fmt:formatNumber value="${stock.buySumQuantity/100}" pattern="#" type="number"/>   
							</td>
							<td align="center" style="color:#2F0000;">
								<fmt:formatNumber value="${stock.buy1Quantity/100}" pattern="#" type="number"/>   
							</td>
							<td align="center" style="color:red;">
								<fmt:formatNumber value="${(stock.buySumQuantity-stock.sellSumQuantity)/100}" pattern="#" type="number"/>
							</td>
							<td align="center" style="color:#2F0000;">
								<fmt:formatNumber value="${stock.sellSumQuantity/100}" pattern="#" type="number"/>
							</td>
							<td align="center" style="color:#2F0000;">
								<fmt:formatNumber value="${stock.sell1Quantity/100}" pattern="#" type="number"/>
							</td>
