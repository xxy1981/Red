...
<html>
	...
	<frameset rows="51,*" cols="*" frameborder="YES" border="1" framespacing="0" bordercolor="#765">
		<frame src="${ctxPath}/jsp/always/top.jsp" name="topFrame" scrolling="NO"
			noresize>
		<frameset cols="150,*" border="1" frameborder="YES" framespacing="1" bordercolor="#765">
			<frame src="${ctxPath}/jsp/always/left.jsp" name="leftFrame">
			<frame src="${ctxPath}/refresh.do?action=always" name="mainFrame">
		</frameset>
		<noframes>
			<body>
			</body>
